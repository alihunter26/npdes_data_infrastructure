...
#
# Input : dmr analysis/01_dmr_fy<year>.csv        (majors-under-individual, all params)
# Output: dmr analysis/02_dmr_fy<year>_00530.csv   (+ PARAMETER_CODE = '00530' only)
#
...
IN_PATH   <- file.path(DMR_ANALYSIS_DIR, sprintf("01_dmr_fy%d.csv", FY))
OUT_PATH  <- file.path(DMR_ANALYSIS_DIR, sprintf("02_dmr_fy%d_00530.csv", FY))
PARAM     <- "00530"
