...
# facility-month panel (scripts 01-06 in code/03_panel_building/), compute what share of
...
#      memory low, mirroring the same chunked-read technique used elsewhere in this
#      repo for the same 16 GB file. Only per-column running totals (n non-missing,
#      n rows) are kept across chunks -- individual rows are discarded after each
