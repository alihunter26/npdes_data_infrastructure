...
| `data/processed/effluent_violations_npdes_month_panel_2005_2025.csv` | `.csv` (derived, external — built by `build_effluent_violations_npdes_month_panel.R` in `../EIL Summer/build/`) | `NPDES_ID`, `month`, `n_D80`/`n_D90`/`n_E90` — existence only (`> 0`) |
