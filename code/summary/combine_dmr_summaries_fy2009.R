...
STAGES <- list(
  list(csv = "01_dmr_fy2009.csv",
       tab = "01_MajorIndividual",
       description = "Ever-major individual (NPD) permits, FY2009 DMR records -- all parameters, outfall types, and monitoring locations kept (broad base file).",
       summary     = "One row per DMR parameter/limit submission for FY2009, restricted to permits that are individual (NPD) and were major in at least one permit version. No parameter, feature-type, or monitoring-location restriction applied yet."),
  list(csv = "02_dmr_fy2009_00530.csv",
       tab = "02_TSS_00530",
  ...
  list(csv = "03_dmr_fy2009_00530_monloc1.csv",
  ...
  list(csv = "04_dmr_fy2009_00530_monloc1_c1q1.csv",
       tab = "04_C1Q1",
...
# ── Styles (identical to combine_dmr_summaries.R) ─────────────────────────────
...
# ── Helper functions (identical to combine_dmr_summaries.R) ──────────────────
...
# ── Write one summary to one worksheet ───────────────────────────────────────
